# app.py
"""
Predictive Delivery Optimizer - Streamlit app for NexGen Logistics
Author: (You)
Description:
 - Loads the 7 CSVs
 - EDA dashboard + interactive filters
 - Trains a Delay classifier and Delay regression model
 - Shows predictions for new/selected orders and recommended actions
